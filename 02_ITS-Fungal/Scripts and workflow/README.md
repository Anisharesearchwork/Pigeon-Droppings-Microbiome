...
R and R studio- for data visualization  and statistical computing environment
...
Representative sequences were taxonomically classified using the UNITE reference database and the Naive Bayes classifier implemented in the QIIME 2plugin.  The taxonomic assignments were visualized and exported for further analysis.
...
## Export
Export of files to various formats using the commands for downstream analysis of the data produced via QIIME2
...
# Exported representative sequences
...
setwd("C:/Users/USER/OneDrive/Desktop/Microbiome_R/Unite")
...
# Import data
imported these data - feature-table.tsv, taxonomy.tsv and metadata_ITS.tsvfor R visualization.
